#LEARN AUDIOLOGY README

Learn-Audiology
------------------------------------------------------------
A training app designed for audiology masking.
It is a web app mainly used on smartphones as a learning aid to assist the student in making the appropriate decisions with the various masking rules.
...
1) Download node js
2) clone source tree
     Source.eait.uq.edu.au/git/deco3800-teamtam
3) pull everything from source tree
4) navigate to project folder on command line
5) type npm install
5) type npm start and it will open the application
5) open folder in editor, src folder has all the code
6) webpage will update like normal html

Testing framework
------------------------------------------------------------
Steps:
1) npm install --save-dev jest
2) create files with name “file”.test.js
3) ensure that in package.json, “scripts” contains “test”: “jest”
4) npm test: run the test suites

Current test files are in tests folder of the project.

Deployment
----------------------------------------------------------
npm run build: this command will create a build folder with an index.html file. Running this command will provide more information about specific deployment strategies.
Current deployment on UQCloud steps:
1) Install FTP program
2) If not on university campus: Download vpn program (Cisco Anyconnect Secure Mobility Client) and connect to vpn.uq.edu.au
3) In FTP, connect to sftp://deco3800-teamtam.zones.eait.uq.edu.au with UQ username and password
4) Navigate to /var/www/htdocs
5) Transfer everything from inside project build folder into the htdocs folder
...
Authors
----------------------------------------------------------
Sim Wei Jie - Front End
Kurt Mahaffey - Front End, Design, Testing
Gianni Poutanen - Front End
Jowin Yien - Database
Yong Qin Lim - Database
Li Tran - Front End
...
Single page app using react router: https://hackernoon.com/simple-guide-to-creating-a-single-page-app-with-react-router-6b6f709a2e3f
Jest testing framework: https://facebook.github.io/jest/
Chartjs-2: https://www.npmjs.com/package/react-chartjs-2
Reactjs-popup: https://hackernoon.com/introducing-reactjs-popup-modals-tooltips-and-menus-all-in-one-227de37766fa
React-responsive-carousel: https://www.npmjs.com/package/react-responsive-carousel

#STANDARD README FOR REACT APP
